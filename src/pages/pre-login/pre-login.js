...
var PreLoginPage = /** @class */ (function () {
    function PreLoginPage(navCtrl, navParams, ngFireAuth) {
    ...
    PreLoginPage.prototype.gotoSignupPage = function () {
        this.navCtrl.push(SignUpPage);
    };
    PreLoginPage.prototype.gotoMainPage = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ngFireAuth.auth.signInWithEmailAndPassword(this.oldUser.emailId, this.oldUser.password)];
                    case 1:
                        result = _a.sent();
                        if (result) {
